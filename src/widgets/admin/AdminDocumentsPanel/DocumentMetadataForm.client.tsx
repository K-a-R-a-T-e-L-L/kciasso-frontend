...
export default function DocumentMetadataForm(props: Props) {
  ...
  return (
    <Stack component="form" gap="md" onSubmit={props.onSubmit as never}>
      {!create ? (
        <Title order={3}>
          {
      ...
      <Textarea
        ...
        onChange={(event) =>
          props.onFieldChange("description", event.currentTarget.value)
        }
      />
      <Group grow align="start">
        <TextInput
          ...
          onChange={(event) =>
            props.onFieldChange("documentNumber", event.currentTarget.value)
          }
        />
        <TextInput
          label={"\u0414\u0430\u0442\u0430"}
          type="date"
          value={props.form.documentDate}
          onChange={(event) =>
            props.onFieldChange("documentDate", event.currentTarget.value)
          }
        />
      </Group>
      <Button variant="light" type="button" onClick={props.onOpenPlacement}>
        {"\u0420\u0430\u0437\u043c\u0435\u0449\u0435\u043d\u0438\u044f"}:{" "}
