...
export const navigation: NavItem[] = [
  ...
  },
  {
    ...
    kind: "dropdown",
    items: [
      { title: "Нормативные документы", href: "/gia-9#docs" },
      { title: "Демоверсии", href: "/gia-9#demo" },
      { title: "Сроки проведения", href: "/gia-9#dates" },
      { title: "Результаты", href: "/gia-9#results" },
      { title: "Отчеты комиссий", href: "/gia-9#reports" },
    ],
  },
  {
    title: "ГИА-11",
    ...
    kind: "dropdown",
    items: [
      { title: "Нормативные документы", href: "/gia-11#docs" },
      { title: "Демоверсии", href: "/gia-11#demo" },
      { title: "Сроки проведения", href: "/gia-11#dates" },
      { title: "Результаты", href: "/gia-11#results" },
      { title: "Отчеты комиссий", href: "/gia-11#reports" },
      { title: "Итоговое сочинение", href: "/gia-11#essay" },
      { title: "Аналитические материалы ЕГЭ", href: "/gia-11#analytics" },
    ],
  },
  {
    title: "О центре",
